"""
Django settings for owgp_48610 project.
...
WSGI_APPLICATION = 'owgp_48610.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "OWGP Support <support@owgp-48610.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "owgp_48610 API",
    "DESCRIPTION": "API documentation for owgp_48610 App",
    "VERSION": "v1",
}
